  ...
  canvas.addEventListener('mousedown', function(e) {
    ...
    for (var i = l-1; i >= 0; i--) {
      if (shapes[i].contains(mx, my)) {
        ...
        myState.clickAngle = myState.getAngle( myState.dragoffx + myState.selection.offsetLeft, myState.dragoffy + myState.selection.offsetTop, event.clientX, event.clientY  ) - myState.angle;
...
function init() {
  var s = new CanvasState(document.getElementById('stack'));
  s.addShape(new Shape(225,225,150,50, 'lightskyblue')); // The default is gray
